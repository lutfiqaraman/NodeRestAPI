...
router.post('/register', async (req, res) => {
    ...
    const emailExist = await UserRoutes.findOne({
...
router.post('/login', async(req, res) => {
    ...
    const user = await UserRoutes.findOne({ email: req.body.email });
...
router.delete('/:uid/only', async(req, res) => {
    try {
        const removedUser = await UserRoutes.remove({ _id: req.params.uid });
...
router.delete('/:uid/all', async(req, res) => {
    try {
        const removedUser = await UserRoutes.remove({ _id: req.params.uid, get: req.body });
